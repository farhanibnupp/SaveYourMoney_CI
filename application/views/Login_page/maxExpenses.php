...
<head>
    ...
    <title>Maksimal Pengeluaran</title>
    <script src="https://code.jquery.com/jquery-3.3.1.min.js"></script>
    <link href="<?= base_url('assets/') ; ?>css/maxExpenses.css" rel="stylesheet">
              ...
              <div class="col-xl-10">
                  <div class="row justify-content-center">
                    <div class="col-sm-6 col-md-6 col-lg-4"id="container">
                        <a href="../Salary/Pendapatan.html" class="previous pt-5">&laquo; kembali</a>
                        <form action="/action_page.php">
                          <div id="judul">
                            <h4 class="text-center">Berapa Maksimal Pengeluaran anda dalam satu bulan ?</h4>
                          </div>
                            ...
                            <div class="container text-center"id="atur-button">
                                <button type="submit" class="btn1 rounded-pill"id ="lebar-button">Finish</button>
                            </div>
                        </form>
                    </div>
                  </div>
